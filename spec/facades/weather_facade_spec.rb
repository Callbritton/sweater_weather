...
describe WeatherFacade do
  context ".instance methods" do
    it "creates a weather object with current weather, hourly weather, and daily weather attributes" do
    ...
    it "creates a daily weather object with forecast data" do
